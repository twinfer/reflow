...
//
//   - An authn.AuthFunc turns each inbound *http.Request into a Principal,
//     resolved from the verified mTLS leaf CN (mesh_authfunc.go).
//
...
// writing one more authn.AuthFunc and composing it in composeAuthFunc.
package auth
