...
var procMap = map[string]procEntry{
	...
	configv1connect.ConfigUpsertEventSourceProcedure:   {"UpsertEventSource", []string{groupTenantConfig}},
	configv1connect.ConfigDeleteEventSourceProcedure:   {"DeleteEventSource", []string{groupTenantConfig}},
	...
	configv1connect.ConfigListEventSourcesProcedure:   {"ListEventSources", []string{groupConfigRead}},
