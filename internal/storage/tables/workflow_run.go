...
// keys.LPFromPartitionKey(routing.PartitionKey(svc, workflow_key)). The row
// outlives the run's Completed status until the workflow retention reaper
// sweeps both rows together.
