...
// ALTSSpec carried the Google ALTS configuration when reflow's
...
func buildALTS(_ *ALTSSpec) (*ListenerCreds, error) {
	return nil, errors.New("reflow/creds: ALTS driver is not supported on the Connect transport; use tls or tls_certprovider")
}
