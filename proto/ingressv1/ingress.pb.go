...
const file_ingressv1_ingress_proto_rawDesc = "" +
	"\n" +
	"\x17ingressv1/ingress.proto\x12\x10reflw.ingress.v1\x1a\x15enginev1/engine.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xab\x01\n" +
	...
	"\fresume_token\x18\x03 \x01(\tR\vresumeToken\"\xac\x01\n" +
	...
	"\x06schema\x18\x05 \x01(\v2\x17.google.protobuf.StructR\x06schema\"\xe3\x01\n" +
...
var file_ingressv1_ingress_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_ingressv1_ingress_proto_goTypes = []any{
	...
	(*GetTaskResponse)(nil),                   // 26: reflw.ingress.v1.GetTaskResponse
	(*ResolveProcessIncidentRequest)(nil),     // 27: reflw.ingress.v1.ResolveProcessIncidentRequest
	(*ResolveProcessIncidentResponse)(nil),    // 28: reflw.ingress.v1.ResolveProcessIncidentResponse
	(*GetProcessInstanceHistoryRequest)(nil),  // 29: reflw.ingress.v1.GetProcessInstanceHistoryRequest
	(*GetProcessInstanceHistoryResponse)(nil), // 30: reflw.ingress.v1.GetProcessInstanceHistoryResponse
	(*ListProcessInstancesRequest)(nil),       // 31: reflw.ingress.v1.ListProcessInstancesRequest
	(*ListProcessInstancesResponse)(nil),      // 32: reflw.ingress.v1.ListProcessInstancesResponse
	(*ProcessInstanceSummary)(nil),            // 33: reflw.ingress.v1.ProcessInstanceSummary
	(*ListInvocationsRequest)(nil),            // 34: reflw.ingress.v1.ListInvocationsRequest
	(*ListInvocationsResponse)(nil),           // 35: reflw.ingress.v1.ListInvocationsResponse
	(*InvocationSummary)(nil),                 // 36: reflw.ingress.v1.InvocationSummary
	(*ResolveWorkflowPromiseRequest)(nil),     // 37: reflw.ingress.v1.ResolveWorkflowPromiseRequest
	(*ResolveWorkflowPromiseResponse)(nil),    // 38: reflw.ingress.v1.ResolveWorkflowPromiseResponse
	(*enginev1.InvocationId)(nil),             // 39: reflw.engine.v1.InvocationId
	(*enginev1.InvocationStatus)(nil),         // 40: reflw.engine.v1.InvocationStatus
	(*enginev1.ModelRef)(nil),                 // 41: reflw.engine.v1.ModelRef
	(enginev1.ProcessStatus)(0),               // 42: reflw.engine.v1.ProcessStatus
	(enginev1.ProcessKind)(0),                 // 43: reflw.engine.v1.ProcessKind
	(*enginev1.ProcessIncident)(nil),          // 44: reflw.engine.v1.ProcessIncident
	(*structpb.Struct)(nil),                   // 45: google.protobuf.Struct
	(enginev1.ProcessIncidentResolution)(0),   // 46: reflw.engine.v1.ProcessIncidentResolution
	(*enginev1.ProcessHistoryEvent)(nil),      // 47: reflw.engine.v1.ProcessHistoryEvent
	(enginev1.InvocationState)(0),             // 48: reflw.engine.v1.InvocationState
	(*enginev1.InvocationTarget)(nil),         // 49: reflw.engine.v1.InvocationTarget
}
var file_ingressv1_ingress_proto_depIdxs = []int32{
	39, // 0: reflw.ingress.v1.AwaitInvocationRequest.invocation_id_proto:type_name -> reflw.engine.v1.InvocationId
	39, // 1: reflw.ingress.v1.DescribeInvocationRequest.invocation_id_proto:type_name -> reflw.engine.v1.InvocationId
	40, // 2: reflw.ingress.v1.DescribeInvocationResponse.status:type_name -> reflw.engine.v1.InvocationStatus
	39, // 3: reflw.ingress.v1.AttachInvocationRequest.invocation_id_proto:type_name -> reflw.engine.v1.InvocationId
	39, // 4: reflw.ingress.v1.GetInvocationOutputRequest.invocation_id_proto:type_name -> reflw.engine.v1.InvocationId
	0,  // 5: reflw.ingress.v1.GetInvocationOutputResponse.status:type_name -> reflw.ingress.v1.GetInvocationOutputResponse.Status
	39, // 6: reflw.ingress.v1.CancelInvocationRequest.invocation_id_proto:type_name -> reflw.engine.v1.InvocationId
	39, // 7: reflw.ingress.v1.PurgeInvocationRequest.invocation_id_proto:type_name -> reflw.engine.v1.InvocationId
	41, // 8: reflw.ingress.v1.StartProcessRequest.model_ref:type_name -> reflw.engine.v1.ModelRef
	41, // 9: reflw.ingress.v1.DeliverProcessEventRequest.model_ref:type_name -> reflw.engine.v1.ModelRef
	41, // 10: reflw.ingress.v1.GetProcessInstanceRequest.model_ref:type_name -> reflw.engine.v1.ModelRef
	42, // 11: reflw.ingress.v1.GetProcessInstanceResponse.status:type_name -> reflw.engine.v1.ProcessStatus
	43, // 12: reflw.ingress.v1.GetProcessInstanceResponse.kind:type_name -> reflw.engine.v1.ProcessKind
	44, // 13: reflw.ingress.v1.GetProcessInstanceResponse.incident:type_name -> reflw.engine.v1.ProcessIncident
	25, // 14: reflw.ingress.v1.GetProcessInstanceResponse.awaiting_tasks:type_name -> reflw.ingress.v1.AwaitingTaskInfo
	45, // 15: reflw.ingress.v1.GetTaskResponse.schema:type_name -> google.protobuf.Struct
	41, // 16: reflw.ingress.v1.ResolveProcessIncidentRequest.model_ref:type_name -> reflw.engine.v1.ModelRef
	46, // 17: reflw.ingress.v1.ResolveProcessIncidentRequest.resolution:type_name -> reflw.engine.v1.ProcessIncidentResolution
	41, // 18: reflw.ingress.v1.GetProcessInstanceHistoryRequest.model_ref:type_name -> reflw.engine.v1.ModelRef
	47, // 19: reflw.ingress.v1.GetProcessInstanceHistoryResponse.events:type_name -> reflw.engine.v1.ProcessHistoryEvent
	41, // 20: reflw.ingress.v1.ListProcessInstancesRequest.model_ref:type_name -> reflw.engine.v1.ModelRef
	42, // 21: reflw.ingress.v1.ListProcessInstancesRequest.status_filter:type_name -> reflw.engine.v1.ProcessStatus
	33, // 22: reflw.ingress.v1.ListProcessInstancesResponse.instances:type_name -> reflw.ingress.v1.ProcessInstanceSummary
	42, // 23: reflw.ingress.v1.ProcessInstanceSummary.status:type_name -> reflw.engine.v1.ProcessStatus
	43, // 24: reflw.ingress.v1.ProcessInstanceSummary.kind:type_name -> reflw.engine.v1.ProcessKind
	48, // 25: reflw.ingress.v1.ListInvocationsRequest.state_filter:type_name -> reflw.engine.v1.InvocationState
	36, // 26: reflw.ingress.v1.ListInvocationsResponse.invocations:type_name -> reflw.ingress.v1.InvocationSummary
	39, // 27: reflw.ingress.v1.InvocationSummary.id:type_name -> reflw.engine.v1.InvocationId
	49, // 28: reflw.ingress.v1.InvocationSummary.target:type_name -> reflw.engine.v1.InvocationTarget
	48, // 29: reflw.ingress.v1.InvocationSummary.state:type_name -> reflw.engine.v1.InvocationState
	1,  // 30: reflw.ingress.v1.Ingress.AwaitInvocation:input_type -> reflw.ingress.v1.AwaitInvocationRequest
	3,  // 31: reflw.ingress.v1.Ingress.ResolveAwakeable:input_type -> reflw.ingress.v1.ResolveAwakeableRequest
	5,  // 32: reflw.ingress.v1.Ingress.DescribeInvocation:input_type -> reflw.ingress.v1.DescribeInvocationRequest
	7,  // 33: reflw.ingress.v1.Ingress.AttachInvocation:input_type -> reflw.ingress.v1.AttachInvocationRequest
	9,  // 34: reflw.ingress.v1.Ingress.GetInvocationOutput:input_type -> reflw.ingress.v1.GetInvocationOutputRequest
	10, // 35: reflw.ingress.v1.Ingress.GetObjectState:input_type -> reflw.ingress.v1.GetObjectStateRequest
	13, // 36: reflw.ingress.v1.Ingress.CancelInvocation:input_type -> reflw.ingress.v1.CancelInvocationRequest
	37, // 37: reflw.ingress.v1.Ingress.ResolveWorkflowPromise:input_type -> reflw.ingress.v1.ResolveWorkflowPromiseRequest
	15, // 38: reflw.ingress.v1.Ingress.PurgeInvocation:input_type -> reflw.ingress.v1.PurgeInvocationRequest
	34, // 39: reflw.ingress.v1.Ingress.ListInvocations:input_type -> reflw.ingress.v1.ListInvocationsRequest
	17, // 40: reflw.ingress.v1.Ingress.StartProcess:input_type -> reflw.ingress.v1.StartProcessRequest
	19, // 41: reflw.ingress.v1.Ingress.DeliverMessage:input_type -> reflw.ingress.v1.DeliverMessageRequest
	21, // 42: reflw.ingress.v1.Ingress.DeliverProcessEvent:input_type -> reflw.ingress.v1.DeliverProcessEventRequest
	23, // 43: reflw.ingress.v1.Ingress.GetProcessInstance:input_type -> reflw.ingress.v1.GetProcessInstanceRequest
	31, // 44: reflw.ingress.v1.Ingress.ListProcessInstances:input_type -> reflw.ingress.v1.ListProcessInstancesRequest
	29, // 45: reflw.ingress.v1.Ingress.GetProcessInstanceHistory:input_type -> reflw.ingress.v1.GetProcessInstanceHistoryRequest
	27, // 46: reflw.ingress.v1.Ingress.ResolveProcessIncident:input_type -> reflw.ingress.v1.ResolveProcessIncidentRequest
	2,  // 47: reflw.ingress.v1.Ingress.AwaitInvocation:output_type -> reflw.ingress.v1.AwaitInvocationResponse
	4,  // 48: reflw.ingress.v1.Ingress.ResolveAwakeable:output_type -> reflw.ingress.v1.ResolveAwakeableResponse
	6,  // 49: reflw.ingress.v1.Ingress.DescribeInvocation:output_type -> reflw.ingress.v1.DescribeInvocationResponse
	8,  // 50: reflw.ingress.v1.Ingress.AttachInvocation:output_type -> reflw.ingress.v1.AttachInvocationResponse
	12, // 51: reflw.ingress.v1.Ingress.GetInvocationOutput:output_type -> reflw.ingress.v1.GetInvocationOutputResponse
	11, // 52: reflw.ingress.v1.Ingress.GetObjectState:output_type -> reflw.ingress.v1.GetObjectStateResponse
	14, // 53: reflw.ingress.v1.Ingress.CancelInvocation:output_type -> reflw.ingress.v1.CancelInvocationResponse
	38, // 54: reflw.ingress.v1.Ingress.ResolveWorkflowPromise:output_type -> reflw.ingress.v1.ResolveWorkflowPromiseResponse
	16, // 55: reflw.ingress.v1.Ingress.PurgeInvocation:output_type -> reflw.ingress.v1.PurgeInvocationResponse
	35, // 56: reflw.ingress.v1.Ingress.ListInvocations:output_type -> reflw.ingress.v1.ListInvocationsResponse
	18, // 57: reflw.ingress.v1.Ingress.StartProcess:output_type -> reflw.ingress.v1.StartProcessResponse
	20, // 58: reflw.ingress.v1.Ingress.DeliverMessage:output_type -> reflw.ingress.v1.DeliverMessageResponse
	22, // 59: reflw.ingress.v1.Ingress.DeliverProcessEvent:output_type -> reflw.ingress.v1.DeliverProcessEventResponse
	24, // 60: reflw.ingress.v1.Ingress.GetProcessInstance:output_type -> reflw.ingress.v1.GetProcessInstanceResponse
	32, // 61: reflw.ingress.v1.Ingress.ListProcessInstances:output_type -> reflw.ingress.v1.ListProcessInstancesResponse
	30, // 62: reflw.ingress.v1.Ingress.GetProcessInstanceHistory:output_type -> reflw.ingress.v1.GetProcessInstanceHistoryResponse
	28, // 63: reflw.ingress.v1.Ingress.ResolveProcessIncident:output_type -> reflw.ingress.v1.ResolveProcessIncidentResponse
