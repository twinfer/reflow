...
// numbering, package, comment prose, and message set are reflw's.
...
type Frame struct {
	...
	// replay map); reflw's wire is happy with the field defaulting to 0.
...
const file_protocolv1_protocol_proto_rawDesc = "" +
	"\n" +
	"\x19protocolv1/protocol.proto\x12\x11reflw.protocol.v1\"M\n" +
	"\x05Frame\x12\x16\n" +
	"\x06header\x18\x01 \x01(\x04R\x06header\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayload\x12\x12\n" +
	"\x04slot\x18\x03 \x01(\rR\x04slot\"\x92\x05\n" +
	"\fStartMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\fR\x02id\x12\x19\n" +
	"\bdebug_id\x18\x02 \x01(\tR\adebugId\x12#\n" +
	"\rknown_entries\x18\x03 \x01(\rR\fknownEntries\x12G\n" +
	"\tstate_map\x18\x04 \x03(\v2*.reflw.protocol.v1.StartMessage.StateEntryR\bstateMap\x12#\n" +
	...
	"\x04kind\x18\r \x01(\x0e2\x17.reflw.protocol.v1.KindR\x04kind\x12#\n" +
	...
	"\fretry_policy\x18\x03 \x01(\v2!.reflw.protocol.v1.RunRetryPolicyR\vretryPolicy\x12\x16\n" +
	"\x05value\x18\x0e \x01(\fH\x00R\x05value\x126\n" +
	"\afailure\x18\x0f \x01(\v2\x1a.reflw.protocol.v1.FailureH\x00R\afailureB\b\n" +
	"\x06result\"\xa3\x01\n" +
	...
	"\fmax_attempts\x18\x04 \x01(\rR\vmaxAttempts\"\x8e\x01\n" +
	"\x13InputCommandMessage\x123\n" +
	"\aheaders\x18\x01 \x03(\v2\x19.reflw.protocol.v1.HeaderR\aheaders\x12.\n" +
	"\x05value\x18\x0e \x01(\v2\x18.reflw.protocol.v1.ValueR\x05value\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\"\x9e\x01\n" +
	"\x14OutputCommandMessage\x120\n" +
	"\x05value\x18\x0e \x01(\v2\x18.reflw.protocol.v1.ValueH\x00R\x05value\x126\n" +
	"\afailure\x18\x0f \x01(\v2\x1a.reflw.protocol.v1.FailureH\x00R\afailure\x12\x12\n" +
	...
	"\x04name\x18\f \x01(\tR\x04name\"\xbb\x01\n" +
	...
	"\x05value\x18\x05 \x01(\v2\x18.reflw.protocol.v1.ValueH\x00R\x05valueB\b\n" +
	"\x06result\"n\n" +
	"\x16SetStateCommandMessage\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12.\n" +
	"\x05value\x18\x03 \x01(\v2\x18.reflw.protocol.v1.ValueR\x05value\x12\x12\n" +
	...
	"\x14result_completion_id\x18\v \x01(\rR\x12resultCompletionId\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\"\x91\x01\n" +
	"-GetLazyStateKeysCompletionNotificationMessage\x12#\n" +
	"\rcompletion_id\x18\x01 \x01(\rR\fcompletionId\x12;\n" +
	"\n" +
	"state_keys\x18\x11 \x01(\v2\x1c.reflw.protocol.v1.StateKeysR\tstateKeys\"i\n" +
	"\x1fGetEagerStateKeysCommandMessage\x122\n" +
	"\x05value\x18\x0e \x01(\v2\x1c.reflw.protocol.v1.StateKeysR\x05value\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\"\x8c\x01\n" +
	"\x18GetPromiseCommandMessage\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x120\n" +
	"\x14result_completion_id\x18\v \x01(\rR\x12resultCompletionId\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\x12\x18\n" +
	"\aservice\x18\r \x01(\tR\aservice\"\xc2\x01\n" +
	...
	"\tcompleted\x18\x02 \x01(\bR\tcompleted\x120\n" +
	"\x05value\x18\x03 \x01(\v2\x18.reflw.protocol.v1.ValueH\x00R\x05value\x126\n" +
	"\afailure\x18\x04 \x01(\v2\x1a.reflw.protocol.v1.FailureH\x00R\afailure\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\x12\x18\n" +
	...
	"\tcompleted\x18\x02 \x01(\bR\tcompleted\x120\n" +
	"\x05value\x18\x03 \x01(\v2\x18.reflw.protocol.v1.ValueH\x00R\x05value\x126\n" +
	"\afailure\x18\x04 \x01(\v2\x1a.reflw.protocol.v1.FailureH\x00R\afailureB\b\n" +
	"\x06result\"\xb3\x02\n" +
	"\x1dCompletePromiseCommandMessage\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12E\n" +
	"\x10completion_value\x18\x02 \x01(\v2\x18.reflw.protocol.v1.ValueH\x00R\x0fcompletionValue\x12K\n" +
	"\x12completion_failure\x18\x03 \x01(\v2\x1a.reflw.protocol.v1.FailureH\x00R\x11completionFailure\x120\n" +
	"\x14result_completion_id\x18\v \x01(\rR\x12resultCompletionId\x12\x12\n" +
	"\x04name\x18\f \x01(\tR\x04name\x12\x18\n" +
	...
	"\rcompletion_id\x18\x01 \x01(\rR\fcompletionId\x12-\n" +
	"\x04void\x18\x04 \x01(\v2\x17.reflw.protocol.v1.VoidH\x00R\x04void\x126\n" +
	"\afailure\x18\x06 \x01(\v2\x1a.reflw.protocol.v1.FailureH\x00R\afailureB\b\n" +
	"\x06result\"}\n" +
	...
	"signalName\x120\n" +
	"\x14result_completion_id\x18\x02 \x01(\rR\x12resultCompletionId\"\xf5\x01\n" +
	"\x19SignalNotificationMessage\x12\x12\n" +
	"\x03idx\x18\x02 \x01(\rH\x00R\x03idx\x12\x14\n" +
	"\x04name\x18\x03 \x01(\tH\x00R\x04name\x12-\n" +
	"\x04void\x18\x04 \x01(\v2\x17.reflw.protocol.v1.VoidH\x01R\x04void\x120\n" +
	"\x05value\x18\x05 \x01(\v2\x18.reflw.protocol.v1.ValueH\x01R\x05value\x126\n" +
	"\afailure\x18\x06 \x01(\v2\x1a.reflw.protocol.v1.FailureH\x01R\afailureB\v\n" +
	"\tsignal_idB\b\n" +
	"\x06result\"\x1f\n" +
	"\tStateKeys\x12\x12\n" +
